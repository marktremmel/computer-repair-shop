...
(function (window) {
  ...
  var ROLES = {
    ...
    firmware: { label: 'Firmware chip', colour: '#e9c46a',
                what: 'A small memory that holds the start-up code the machine runs before anything else \u2014 the part that knows how to wake the rest of the board up.',
                tell: 'Winbond, GigaDevice or Macronix; "serial NOR flash" or "EEPROM", a few megabytes at most.' },
